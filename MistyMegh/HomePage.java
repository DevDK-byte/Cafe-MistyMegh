...
class HomePage extends JFrame implements ActionListener,MouseListener
{
	...
	public HomePage()
	{
		...
		appImg = new ImageIcon("register.jpg");
		...
		addImg = new ImageIcon("advertise.jpg");
		...
		ImageIcon img1 = new ImageIcon("pizza.jpg");
		...
		ImageIcon img2 = new ImageIcon("sandwich.jpg");
		...
		ImageIcon img3 = new ImageIcon("coffee.jpg");
