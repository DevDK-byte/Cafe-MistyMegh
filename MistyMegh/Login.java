...
class Login extends JFrame implements ActionListener
{
    ...
    JButton loginbtn, rgstrbtn, backbtn,eyebutton;
		...
		eyebutton.addActionListener(new ActionListener()
		{
		    ...
		    public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					 ...
					 eye2 = new ImageIcon("eyecon2.jpg");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			...
			{
				JOptionPane.showMessageDialog(null,"Your Username or Password is Invalid!","Login unsuccessfull",JOptionPane.ERROR_MESSAGE);
				return;
			}
		}
		catch(Exception me)
